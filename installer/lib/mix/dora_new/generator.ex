defmodule Dora.New.Generator do
  def run(project) do
  ...
  defp template_files(project) do
    [
      ...
      {"lib/application.ex", "lib/application.ex"},
  ...
  defp template_path(input) do
    Path.join(Application.app_dir(:dora_new, "priv/templates"), input)
  end
