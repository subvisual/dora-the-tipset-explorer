defmodule Mix.Tasks.Dora.New do
  @moduledoc """
  Creates a new Dora project.

  Expects the project name as an argument.

      mix dora.new my_site [--path PATH] [--module MODULE]
  ...
  * `--module` - name of the base module to be generated.
  ...
  alias Dora.New.{Generator, Project}

  @doc false
  def run(args) do
    case parse_opts(args) do
      {nil, []} ->
        Mix.Tasks.Help.run(["dora.new"])
