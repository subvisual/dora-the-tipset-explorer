defmodule DoraWeb.UserAuth do
  use DoraWeb, :verified_routes
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      DoraWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule DoraWeb.PageLive do
        use DoraWeb, :live_view

        on_mount {DoraWeb.UserAuth, :mount_current_user}
        ...
      end
